class DateFilter {
  init(params) {
    ...
    this.gui.innerHTML = `
    <div
      id="updatesDateFilterDiv"
      class="dateFilterDiv"
    >
      <input
        type="range"
        id="updatesDateFilterInput"
    ...
    this.input = this.gui.querySelector("#updatesDateFilterInput");
    this.label = this.gui.querySelector("#updatesDateFilterLabel");
